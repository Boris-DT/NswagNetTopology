...
using Nswag14_0_7_Type_Mapper.TypeMappers;

namespace Nswag14_0_7_Type_Mapper
{
    internal class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                document.SchemaSettings.TypeMappers.Add(new PointTypeMapper());
                document.SchemaSettings.TypeMappers.Add(new LineStringTypeMapper());
